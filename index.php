...
<body>
            ...
            <div class="container-fluid position-relative">
                ...
                <div class="collapse position-absolute w-100 mt-3" id="menuitem" style="top: 100%; left: 0;">
                    <div class="collapsed-content">
                        ...
                        <a href="./admin/gallery.php" class="btn btn-primary mb-2 bttnz">Galería</a>
        ...
        <div id="carslpics" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100" src="./img/carous2.png" alt="First slide">
                ...
                <div class="carousel-item">
                    <img class="d-block w-100" src="./img/carous3.png" alt="Second slide">
                    <div class="carousel-caption">
                        <h5 class="carsltitle">Centro Formación Profesional N°61</h5>
                ...
                <div class="carousel-item">
                    <img class="d-block w-100" src="./img/carous1.png" alt="Third slide">
                    <div class="carousel-caption">
                        <h5 class="carsltitle">Centro Formación Profesional N°61</h5>
    ...
    <section id="abt">
        <h3>¿Quienes Somos?</h3>
        <p>El <strong>CENTRO FORMACIÓN PROFESIONAL N° 61</strong> dependiente de la Dirección de Educación Técnico Profesional del Consejo General de Educación funciona en la Localidad de La Criolla desde el año 2014 y actualmente cuenta con un anexo en la ciudad vecina de Colonia Ayuí.</p>
        <p>Somos una institución educativa que brinda trayectos de formación profesional y capacitación laboral para una rápida inserción en el mercado socioproductivo local y regional. </p>
        <p>La Formación Profesional permite compatibilizar la promoción social, profesional y personal con la productividad de la economía nacional, regional y local.</p>
    </section>
    <br>

    <section id="obj">
        <h3>Propósitos y objetivos:</h3>
        <p>Nuestra oferta busca <b>preparar, actualizar y desarrollar</b> las capacidades de las personas para el mundo del trabajo. Capacitamos en conocimientos específicos, competencias básicas, profesionales y sociales para que jóvenes y adultos/as puedan mejorar sus oportunidades de empleabilidad.</p>
        <p>La oferta de cursos y trayectos se orienta a temáticas como: Informática, gastronomía, herrería, electricidad, belleza y cosmética, marroquinería, entre otras.</p>
    </section>
    <br>

    <section id="try">
        <h3>Trayectos</h3>
        <p>Por el momento, los trayectos que tenemos son los siguientes:</p>
    ...
    <section id="cnt">
        ...
        <p>Para contactarnos, puede utilizar nuestras redes sociales o nuestros correos electrónicos:</p>
        <div class="container">
            ...
            <div class="wrapper">
                <div class="content">
                    ...
                    <br>
                    <p><b>También puede contactarnos directamente a nuestro email a través de este formulario:</b></p>
